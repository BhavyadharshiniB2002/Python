...
def customerloginpage(data,win):
    ...
    f2=Label(win,text="@bhavya",font=label_font,bg="blue",fg="white")
    f2.pack()
...
def custreg(win):
    ...
    f2=Frame(win,width=1500,height=50,bg="blue")
    label_font=font.Font(weight="bold",family="Times New Roman",size=30)
    f2=Label(win,font=label_font,bg="blue",fg="white")
    f2.pack()
...
def home():
    ...
    s="""A bank is a financial institution that accepts deposits from the public and creates a 
demand deposit while simultaneously making loans. A bank is a financial institution 
that is licensed to accept checking and savings deposits and make loans. Lending activities
can be directly performed by the bank or indirectly through capital markets."""
    l1=Label(win,text=s,font=label_font)
    l1.place(relx=0.28,rely=0.2)
    f1=Frame(win,width=350,height=750,bg="pink")
    f1.place(relx=0.00,rely=0.06)
    b=Button(win,text="Customer Registration",bg="green",fg="white",font=label_font,command=lambda:custreg(win))
    b.place(relx=0.04,rely=0.1)
